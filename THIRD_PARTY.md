...
| Sherlock 0.16.1 | MIT | Pinned runtime dependency for M4. Upstream source/data are not copied into this repository. PersonaLattice reads the package's bundled dataset in place and filters it to an eight-site reviewed allowlist; it does not use Sherlock's live manifest/exclusions loader. |

...
assert.ok(
  allUnavailableIndex >= 0 && combinedLimitsIndex > allUnavailableIndex && withheldIndex > combinedLimitsIndex && notAttemptedIndex > withheldIndex && noMatchIndex > notAttemptedIndex,
